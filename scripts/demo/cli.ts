...
try {
  ...
  console.log(`Created ${result.assets} synthetic Assets across ${result.groups} Groups for ${result.accounts} accounts. Evaluator scopes: ${JSON.stringify(result.scopes)}.`);
