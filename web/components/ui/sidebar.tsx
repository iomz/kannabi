...
// Kannabi keeps the navigation width in local storage, beside the theme hint:
// it is a per-device viewing preference, not something the server should be
// told about a person on every request. The upstream cookie is therefore not
// written here; `web/appearance.ts` owns where the preference lives, and the
// shell passes it in as `open`.
